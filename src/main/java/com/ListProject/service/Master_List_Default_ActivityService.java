...
public class Master_List_Default_ActivityService extends GpBaseService  {
	...
	public void set_ListType_Default_ActivityService(ListType_Default_ActivityService ListType_Default_ActivityService) {
	...
	public Master_List master_list_search_for_update(long id, GpUser user) throws Exception {
		...
		try{
			...
			the_Master_List.setListtype(ListType_Default_ActivityService.get_listtype_by_parent_id(the_Master_List.getId()));
