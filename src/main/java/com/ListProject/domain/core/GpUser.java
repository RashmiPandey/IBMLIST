...
public class GpUser implements UserDetails {
	...
	/**
	 *
	 * For now this class is only used to make the compile succeed and therefore
	 ...
	 *
	 * You should then allow the person using Geppetto to add more fields to in
	 * the Noun editor - Dan Castillo 01/28/2015
	 *
	 *
	 */
