...
public class Task_Default_ActivityController extends GpBaseController {
	...
	@ApiOperation(value = "/get_all_Task/{listid}", httpMethod = "GET", notes = "special search that gets all values of Task", response = Task.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "The request was fulfilled"),
			@ApiResponse(code = 404, message = "The server has not found anything matching the URI given"),
			@ApiResponse(code = 500, message = "Internal server error due to encoding the data"),
			@ApiResponse(code = 400, message = "Bad request due to decoding the data"),
			@ApiResponse(code = 412, message = "Pre condition failed due to required data not found") })
	@RequestMapping(method = RequestMethod.GET, value = "/get_all_Task/{listid}", headers = "Accept=application/json")
	@ResponseBody
	public ArrayList<Task> get_all_Task(@PathVariable("listid") Long listid) throws Exception {

		ArrayList<Task> Task_list = new ArrayList<Task>();

		Task_list = Task_Default_Activity_service.get_all_task(listid,super.getUser());
	...
	@ApiOperation(value = "/get_user_Task/{userId}", httpMethod = "GET", notes = "special search that gets all values of Task", response = Task.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "The request was fulfilled"),
			@ApiResponse(code = 404, message = "The server has not found anything matching the URI given"),
			@ApiResponse(code = 500, message = "Internal server error due to encoding the data"),
			@ApiResponse(code = 400, message = "Bad request due to decoding the data"),
			@ApiResponse(code = 412, message = "Pre condition failed due to required data not found") })
	@RequestMapping(method = RequestMethod.GET, value = "/get_user_Task/{userId}", headers = "Accept=application/json")
	@ResponseBody
	public ArrayList<Task> get_user_Task(@PathVariable("userId") Long userId) throws Exception {

		ArrayList<Task> Task_list = new ArrayList<Task>();

		Task_list = Task_Default_Activity_service.get_user_tasks(userId);
