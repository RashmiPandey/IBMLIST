...
@Api(value = "/Task_Default_Activity", description = "Task_Default_Activity of Task_Default_Activity", 
...
public class Task_Default_ActivityController extends GpBaseController {
	...
	@ApiOperation(value = "/create_Task", httpMethod = "POST",
	notes = "creates a noun of Task", 
	response = Task.class)
    @ApiResponses(value = { 
	...
	@ApiOperation(value = "/update_Task", httpMethod = "PUT",
	notes = "updates a noun of Task", 
	response = Task.class)
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request was fulfilled"),
	    @ApiResponse(code = 404, message = "The server has not found anything matching the URI given"),
	...
	@ApiOperation(value = "/search_for_update_Task/{Task_id}", httpMethod = "GET",
	notes = "updates a noun of Task", 
	response = Task.class)
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request was fulfilled"),
	...
	@ApiOperation(value = "/delete_Task/{Task_id}", httpMethod = "DELETE",
	notes = "deletes a noun of Task", 
	response = Task.class)
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request was fulfilled"),
	    @ApiResponse(code = 404, message = "The server has not found anything matching the URI given"),
	...
	@ApiOperation(value = "/get_all_Task", httpMethod = "GET",
	notes = "special search that gets all values of Task", 
	response = Task.class)
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request was fulfilled"),
	    @ApiResponse(code = 404, message = "The server has not found anything matching the URI given"),
